...
Eğer $y - \cdot \hat{y} \geq 1$, doğru sınıflandırma yapılmış demektir ve kayıp sıfır olur. Ancak, $y \cdot \hat{y} < 1$ olduğunda kayıp pozitif olur ($0 < 1 - y \cdot \hat{y}$) ve hata miktarı artar.
